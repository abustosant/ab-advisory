...
export const metadata: Metadata = {
  title: 'Insights | AB Advisory — Artículos sobre IFRS, Finanzas y Advisory',
  description: 'Artículos técnicos sobre IFRS, finanzas corporativas, reestructuración de deuda y compliance en Chile. Por Andrés Bustos A., fundador de AB Advisory.',
