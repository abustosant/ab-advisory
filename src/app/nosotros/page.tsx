...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.abadvisory.cl/nosotros' },
  openGraph: {
  ...
  twitter: { card: 'summary_large_image', title: 'Andrés Bustos A. — Fundador | AB Advisory', description: '20+ años en finanzas corporativas, IFRS y reestructuración. Ex-LATAM Airlines Group. Firma boutique Santiago, Chile.' },
}
