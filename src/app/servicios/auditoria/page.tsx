...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.abadvisory.cl/servicios/auditoria' },
  openGraph: {
  ...
  twitter: { card: 'summary_large_image', title: 'Auditoría & Control Interno | AB Advisory', description: 'Diseño de controles internos y Big Four prep con marcos COSO 2013 e IIA para empresas en Chile.' },
}
